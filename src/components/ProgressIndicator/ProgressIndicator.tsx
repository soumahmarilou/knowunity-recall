 ...
 * thickness (24/16) x progress (0/25/50/75/100), plus a showText boolean
 * for a percentage label. Progress is stepped in quarters, not a free
 * 0-100 value.
 *
 ...
 *
 * DON'T: Don't treat the 25% steps as fine-grained enough for continuous
 ...
 * live component's actual example text reads "6/12" (a fraction), not
 * "50%" — and thickness=16 has no text layer at all in Figma, so showText
...
export type ProgressIndicatorValue = "0" | "25" | "50" | "75" | "100";
